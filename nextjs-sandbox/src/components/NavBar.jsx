    ...
    return (
        <nav className="NavBar"
            ...
            <ul className="menu">
                ...
                <li>
                    <Link href="/dash" className={path.startsWith('/dash') ?
                        'active' : null}>Dashboard</Link>
                </li>
                <li>
                    <Link
                        href="/about" className={path.startsWith('/about') ?
                            'active' : null}>About</Link>
                </li>
                <li>
                    <Link
                        href="/posts" className={path.startsWith('/posts') ?
                            'active' : null}>Posts</Link>
                </li>
            </ul>
        </nav>
    )
